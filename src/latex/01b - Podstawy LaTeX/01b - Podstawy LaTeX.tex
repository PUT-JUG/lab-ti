...
\end{figure}
	...
	Portal Overleaf pozwala na kolaboracyjne tworzenie dokumentów \LaTeX (\url{https://www.overleaf.com/}). Po zalogowaniu widoczna jest lista projektów, przycisk do dodawania nowych znajduje się u góry po lewej stronie (Ilustracja~\ref{rys:Overleaf:NowyProjekt}).
